...
Ba;this.targetIds={};F.apply(this,arguments)}function U(m,q){var r=x(m.touches),z=this.targetIds;if(q&3&&1===r.length)return z[r[0].identifier]=!0,[r,r];m=x(m.changedTouches);var C=[],D=this.target;var E=r.filter(function(J){return w(J.target,D)});if(1===q)for(r=0;r<E.length;)z[E[r].identifier]=!0,r++;for(r=0;r<m.length;)z[m[r].identifier]&&C.push(m[r]),q&12&&delete z[m[r].identifier],r++;if(C.length)return[y(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var m=n(this.handler,
...
BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var n=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,t=e*k,B=0,w=0,v=0,u=0;toolBar&&(B=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+
10,w=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,v=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+v}else x=-l-h*e*d.parameters.zoomArea.left/100+v,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;t>windowHeight?(h=windowHeight-t-n+k*e*d.parameters.zoomArea.bottom/100-w,d=-n-k*e*d.parameters.zoomArea.top/
100+B):(h=-n-k*e*d.parameters.zoomArea.top/100+B,d=windowHeight-t-n+k*e*d.parameters.zoomArea.bottom/100-w);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||!e.pointers||0>=e.pointers.length||
!f)return{x:0,y:0};var g=this.getPageXY(e);e=g.pageX;g=g.pageY;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left;d=d.parameters.top;l=(f.x*h/100+l).toFixed(2);f=(f.y*k/100+d).toFixed(2);e-=parseFloat(l);f=g-parseFloat(f);return{x:parseFloat(e.toFixed(2)),y:parseFloat(f.toFixed(2))}};this.mathOrigin=function(d,e){if(!e||!e.pointers||0>=e.pointers.length)return{x:50,y:50};var f=this.getPageXY(e);e=f.pageX;f=f.pageY;var g=d.parameters.width;var h=d.parameters.height;var k=this.getBookOffset(d);
e=(e-parseInt(k.left))/(g*d.parameters.scale);d=(f-parseInt(k.top))/(h*d.parameters.scale);return{x:(100*e).toFixed(2),y:(100*d).toFixed(2)}};this.getPageXY=function(d){var e=bookConfig.upsideOnMobile();if(1==d.pointers.length){var f=d.pointers[0].pageX;var g=d.pointers[0].pageY}1<d.pointers.length&&(f=(d.pointers[0].pageX+d.pointers[1].pageX)/2,g=(d.pointers[0].pageY+d.pointers[1].pageY)/2);return e?{pageX:g,pageY:windowHeight-f}:{pageX:f,pageY:g}};this.getBookOffset=function(d){if(d)return d=d.offset(),
bookConfig.upsideOnMobile()?{left:d.top,top:d.left}:{left:d.left,top:d.top}};this.restrictInBoundary=function(d,e){if(!d.parameters.eventCancel&&!d.parameters.zoomming){var f=d.parameters.tran,g=this.tranLimit(d,d.parameters.scale,f);if(g.x!=parseInt(f.x)||g.y!=parseInt(f.y)){d.animateInterval&&d.animateInterval.stop();var h=0,k=0;g.x!=f.x&&(h=g.x-f.x);g.y!=f.y&&(k=g.y-f.y);d.animateInterval=function(l,n){var p=$.easing.easeOutBack(null,l,0,h,n),t=$.easing.easeOutBack(null,l,0,k,n);0<l&&(p-=$.easing.easeOutBack(null,
l-1,0,h,n),t-=$.easing.easeOutBack(null,l-1,0,k,n));l>=n&&(t=d.parameters.tran,p=g.x-t.x,t=g.y-t.y);p=d.panForMove(d,p,t);d.setZoomParameters(d,p);l>=n&&(d.animateInterval.stop(),BookInfo.getBook().bookAttachments&&BookInfo.getBook().bookAttachments.Items.find("ZoomMap").each(function(B){B.refreshArea()}),e&&"function"==typeof e&&e())}.animation(this,320)}}};this.transformSetting=function(d,e){d.setZoomParameters(d,e);e=transformCSS(e);d.css(e)};this.panForMove=function(d,e,f,g){var h=d.parameters?
d.parameters.tran:{x:0,y:0};g=d.parameters?d.parameters.scale:1;h||(h={x:0,y:0});g||0==g||(g=1);e=parseInt(h.x+e);f=parseInt(h.y+f);f={x:e,y:f};e=transformCSS({tran:f,scale:g});d.css(e);return{tran:f,scale:g}};this.originObj=function(d,e){d.css({"-webkit-transform-origin":e.x+"% "+e.y+"%","-moz-transform-origin":e.x+"% "+e.y+"%","-ms-transform-origin":e.x+"% "+e.y+"%","-o-transform-origin":e.x+"% "+e.y+"%"})};this.setZoomParameters=function(d,e){function f(k){return void 0!==k&&null!==k}function g(k){return f(e[k])&&
!isNaN(e[k])?e[k]:d.parameters[k]}function h(k){return f(e[k])?e[k]:d.parameters[k]}d&&d.parameters&&e&&(d.parameters={width:g("width"),height:g("height"),naturalWidth:g("naturalWidth"),naturalHeight:g("naturalHeight"),left:g("left"),top:g("top"),scale:g("scale"),rotate:g("rotate"),toScale:g("toScale"),tran:h("tran"),origin:h("origin"),zoomFlag:h("zoomFlag"),zoomming:h("zoomming"),zoomOut:h("zoomOut"),resize:h("resize"),eventCancel:h("eventCancel"),zoomArea:h("zoomArea"),zoomDelay:h("zoomDelay"),
onPan:h("onPan"),onSwipe:h("onSwipe"),onDoubleTap:h("onDoubleTap"),onPinch:h("onPinch")})};this.animateToTransform=function(d,e,f){if(!this.parameters.eventCancel&&!this.parameters.zoomming){this.options&&this.options.zoomStart&&this.options.zoomStart();var g=this.getBookOffset($(this));this.parameters.tran=getTransform(this[0]);if(parseInt(e.x)!=parseInt(this.parameters.tran.x)||parseInt(e.y)!=parseInt(this.parameters.tran.y)||d.toFixed(2)!=this.parameters.scale.toFixed(2)){this.parameters.zoomming=
!0;this.parameters.left=g.left-this.parameters.tran.x;this.parameters.top=g.top-this.parameters.tran.y;this.parameters.width=$(this).width();this.parameters.height=$(this).height();this.parameters.naturalWidth=$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.origin=this.parameters.origin;h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;e=transformCSS(h);this.originObj(this,h.origin);animateOnce(this,e,300,function(){getTransform(this[0]);this.transformSetting(this,
h);this.parameters.scale=d;this.parameters.toScale=d;this.parameters.zoomming=!1;if(this.options.onZoomed)this.options.onZoomed(h)}.bind(this),"%stransform","ease-out")}}};this.animateToTransform=function(d,e,f){if(!this.parameters.eventCancel&&!this.parameters.zoomming){this.options&&this.options.zoomStart&&this.options.zoomStart();var g=this.getBookOffset($(this));this.parameters.tran=getTransform(this[0]);if(parseInt(e.x)!=parseInt(this.parameters.tran.x)||parseInt(e.y)!=parseInt(this.parameters.tran.y)||
d.toFixed(2)!=this.parameters.scale.toFixed(2)){this.parameters.zoomming=!0;this.parameters.left=g.left-this.parameters.tran.x;this.parameters.top=g.top-this.parameters.tran.y;this.parameters.width=$(this).width();this.parameters.height=$(this).height();this.parameters.naturalWidth=$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,
t){n(p,t,"Sine")}).animation(this,300)}.bind(this),n=function(p,t,B){if(p<t){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,t);var w=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,t);p=k(null,p,this.parameters.scale,d-this.parameters.scale,t);t={};t.scale=p;t.tran={x:B,y:w};B=transformCSS(t);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);
l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,e,h.tran);this.zoomTran=h;this.animation(d,e,h,g)}};this.animation=function(d,e,f,g){var h=transformCSS(f);d.originObj(d,f.origin);animateOnce(d,h,void 0==g?600:g,function(){getTransform(d[0]);d.transformSetting(d,
f);d.parameters.scale=e;d.parameters.toScale=e;d.parameters.zoomming=!1;var k=(d.parameters.width*d.parameters.toScale).toFixed(2),l=(d.parameters.height*d.parameters.toScale).toFixed(2),n=d.parameters.naturalWidth,p=d.parameters.naturalHeight;if(Number.isBetween(k,n-1,n+1)||Number.isBetween(l,p-1,p+1)){d.timeout&&(d.timeout=void 0,window.clearTimeout(d.timeout));d.parameters.zoomDelay=!1;if(d.options.onZoomed)d.options.onZoomed(d.zoomTran);d.zoomOut(d)}else if(d.options.onZoomed)d.options.onZoomed(d.zoomTran)}.bind(d),
"%stransform","cubic-bezier(0.2150, 0.610, 0.3550, 1)")};this.delayExecuteOnZoomed=function(d){d.timeout=window.setTimeout(function(){if(d.parameters.zoomFlag&&!d.parameters.onPinch&&!d.parameters.zoomming)d.options.onZoomed(d.zoomTran);d.parameters.zoomDelay=!1;window.clearTimeout(d.timeout);d.timeout=void 0},3E3)};this.registerParamers=function(d){d&&(void 0!=d.width&&(this.parameters.width=d.width),void 0!=d.height&&(this.parameters.height=d.height),void 0!=d.left&&(this.parameters.left=d.left),
void 0!=d.top&&(this.parameters.top=d.top),void 0!=d.scale&&(this.parameters.scale=d.scale),void 0!=d.tran&&(this.parameters.tran=d.tran),void 0!=d.origin&&(this.parameters.origin=d.origin))};this.setZoomSize=function(){var d=$(this).width(),e=$(this).height(),f=bookConfig.largePageHeight/bookConfig.largePageWidth,g=bookConfig.middleZoomWidth,h=g*f,k=getPageSize(BookInfo.getCurrentPageIndex(),"normal",bookConfig.totalPageCount);if(k&&1<k.length)if(1<=f){var l=findCloseNum(k,1350),n=l/f;k=k[k.length-
1];var p=k/f}else n=findCloseNum(k,1350),l=n*f,p=k[k.length-1],k=p*f;else l=1350,n=l/f,k=2050,p=k/f;bookConfig.FlipDirection?(f=g/d,this.middleScale=Math.max(n/d,f,2),isPhone()||isPad()?this.maxScale=Math.max(p/d,f,4):this.maxScale=1E4/d):(f=h/e,this.middleScale=Math.max(l/e,f,2),isPhone()||isPad()?this.maxScale=Math.max(k/e,f,4):this.maxScale=1E4/e)};b=window.self!==window.top?"pan-y":"none";b=new Hammer.Manager($(this)[0],{touchAction:b});b.add(new Hammer.Pan);b.add((new Hammer.Swipe({velocity:.15})).recognizeWith(b.get("pan")));
b.on("panstart panmove panend pancancel",this.onPan.bind(this));b.on("swipe swipeup",this.onSwipe.bind(this));if(bookConfig.SupportOperatePageZoom&&(b.add(new Hammer.Pinch),isPhone()||isPad()?b.add(new Hammer.Tap({event:"doubletap",taps:2,interval:400,posThreshold:30})):b.add(new Hammer.Tap({event:"doubletap",taps:2})),b.on("pinchstart pinchmove pinchcancel pinchend",this.onPinch.bind(this)),!isAndroidWeChat()))b.on("doubletap",this.onDoubleTap.bind(this));this.setZoomSize()};
...
t.data[k+1]/255*w.g),t.data[k+2]!=w.b&&(B.data[k+2]=t.data[k+2]/255*w.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
(function(b){function c(w,v){var u=(w&65535)+(v&65535);return(w>>16)+(v>>16)+(u>>16)<<16|u&65535}function d(w,v,u,x,y,A){w=c(c(v,w),c(x,A));return c(w<<y|w>>>32-y,u)}function e(w,v,u,x,y,A,G){return d(v&u|~v&x,w,v,y,A,G)}function f(w,v,u,x,y,A,G){return d(v&x|u&~x,w,v,y,A,G)}function g(w,v,u,x,y,A,G){return d(u^(v|~x),w,v,y,A,G)}function h(w,v){w[v>>5]|=128<<v%32;w[(v+64>>>9<<4)+14]=v;var u=1732584193,x=-271733879,y=-1732584194,A=271733878;for(v=0;v<w.length;v+=16){var G=u;var F=x;var O=y;var L=A;
u=e(u,x,y,A,w[v],7,-680876936);A=e(A,u,x,y,w[v+1],12,-389564586);y=e(y,A,u,x,w[v+2],17,606105819);x=e(x,y,A,u,w[v+3],22,-1044525330);u=e(u,x,y,A,w[v+4],7,-176418897);A=e(A,u,x,y,w[v+5],12,1200080426);y=e(y,A,u,x,w[v+6],17,-1473231341);x=e(x,y,A,u,w[v+7],22,-45705983);u=e(u,x,y,A,w[v+8],7,1770035416);A=e(A,u,x,y,w[v+9],12,-1958414417);y=e(y,A,u,x,w[v+10],17,-42063);x=e(x,y,A,u,w[v+11],22,-1990404162);u=e(u,x,y,A,w[v+12],7,1804603682);A=e(A,u,x,y,w[v+13],12,-40341101);y=e(y,A,u,x,w[v+14],17,-1502002290);
x=e(x,y,A,u,w[v+15],22,1236535329);u=f(u,x,y,A,w[v+1],5,-165796510);A=f(A,u,x,y,w[v+6],9,-1069501632);y=f(y,A,u,x,w[v+11],14,643717713);x=f(x,y,A,u,w[v],20,-373897302);u=f(u,x,y,A,w[v+5],5,-701558691);A=f(A,u,x,y,w[v+10],9,38016083);y=f(y,A,u,x,w[v+15],14,-660478335);x=f(x,y,A,u,w[v+4],20,-405537848);u=f(u,x,y,A,w[v+9],5,568446438);A=f(A,u,x,y,w[v+14],9,-1019803690);y=f(y,A,u,x,w[v+3],14,-187363961);x=f(x,y,A,u,w[v+8],20,1163531501);u=f(u,x,y,A,w[v+13],5,-1444681467);A=f(A,u,x,y,w[v+2],9,-51403784);
y=f(y,A,u,x,w[v+7],14,1735328473);x=f(x,y,A,u,w[v+12],20,-1926607734);u=d(x^y^A,u,x,w[v+5],4,-378558);A=d(u^x^y,A,u,w[v+8],11,-2022574463);y=d(A^u^x,y,A,w[v+11],16,1839030562);x=d(y^A^u,x,y,w[v+14],23,-35309556);u=d(x^y^A,u,x,w[v+1],4,-1530992060);A=d(u^x^y,A,u,w[v+4],11,1272893353);y=d(A^u^x,y,A,w[v+7],16,-155497632);x=d(y^A^u,x,y,w[v+10],23,-1094730640);u=d(x^y^A,u,x,w[v+13],4,681279174);A=d(u^x^y,A,u,w[v],11,-358537222);y=d(A^u^x,y,A,w[v+3],16,-722521979);x=d(y^A^u,x,y,w[v+6],23,76029189);u=d(x^
y^A,u,x,w[v+9],4,-640364487);A=d(u^x^y,A,u,w[v+12],11,-421815835);y=d(A^u^x,y,A,w[v+15],16,530742520);x=d(y^A^u,x,y,w[v+2],23,-995338651);u=g(u,x,y,A,w[v],6,-198630844);A=g(A,u,x,y,w[v+7],10,1126891415);y=g(y,A,u,x,w[v+14],15,-1416354905);x=g(x,y,A,u,w[v+5],21,-57434055);u=g(u,x,y,A,w[v+12],6,1700485571);A=g(A,u,x,y,w[v+3],10,-1894986606);y=g(y,A,u,x,w[v+10],15,-1051523);x=g(x,y,A,u,w[v+1],21,-2054922799);u=g(u,x,y,A,w[v+8],6,1873313359);A=g(A,u,x,y,w[v+15],10,-30611744);y=g(y,A,u,x,w[v+6],15,-1560198380);
x=g(x,y,A,u,w[v+13],21,1309151649);u=g(u,x,y,A,w[v+4],6,-145523070);A=g(A,u,x,y,w[v+11],10,-1120210379);y=g(y,A,u,x,w[v+2],15,718787259);x=g(x,y,A,u,w[v+9],21,-343485551);u=c(u,G);x=c(x,F);y=c(y,O);A=c(A,L)}return[u,x,y,A]}function k(w){var v,u="",x=32*w.length;for(v=0;v<x;v+=8)u+=String.fromCharCode(w[v>>5]>>>v%32&255);return u}function l(w){var v,u=[];u[(w.length>>2)-1]=void 0;for(v=0;v<u.length;v+=1)u[v]=0;var x=8*w.length;for(v=0;v<x;v+=8)u[v>>5]|=(w.charCodeAt(v/8)&255)<<v%32;return u}function n(w){return k(h(l(w),
8*w.length))}function p(w,v){var u=l(w),x=[],y=[];x[15]=y[15]=void 0;16<u.length&&(u=h(u,8*w.length));for(w=0;16>w;w+=1)x[w]=u[w]^909522486,y[w]=u[w]^1549556828;v=h(x.concat(l(v)),512+8*v.length);return k(h(y.concat(v),640))}function t(w){var v="",u;for(u=0;u<w.length;u+=1){var x=w.charCodeAt(u);v+="0123456789abcdef".charAt(x>>>4&15)+"0123456789abcdef".charAt(x&15)}return v}function B(w,v,u){v?u?w=p(unescape(encodeURIComponent(v)),unescape(encodeURIComponent(w))):(w=p(unescape(encodeURIComponent(v)),
...
function getYouTubeIdFromUrl(b){if(b.includes("youtube.com/watch?")&&b.includes("v=")&&b.split("v=")[1]){var c=(new URLSearchParams((new URL(b)).search)).get("v");return c?c:b}return b}
...
var tmpBookConfig={},checkBookConfig=function(){var b=allocateUTF8(htmlConfig.bookConfig);window.key_index=Module._DeConfig_Parse(b);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.isTabelOfContentSearchBarVisible=getConfigValue("isTabelOfContentSearchBarVisible",!0);tmpBookConfig.mouseDragFlip=getConfigValue("mouseDragFlip",!0);tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",
...
void 0!=tmpBookConfig[d]&&(tmpBookConfig[d]=!1)}}catch(e){}recordError();c=Module._getVerifyString();d=UTF8ToString(c);Module._free(c);eval(d)};
...
var VERSION_NAME="6.4.9",BUILD_DATE="2025022701",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType={WEBKIT:1,OPERA:1,MOZ:2,MS:3},Direction={left:"left",right:"right",
...
void 0===A?"json":A;F.open("GET",u);F.send();F.onreadystatechange=function(){4===F.readyState&&(200===F.status||304===F.status?x&&x(F):"bookinfo"===G&&x?x():y&&y(x))};F.error=function(){y&&y(x)}}function d(u,x){v&&(clearTimeout(v),v=null);if(window.Module.isReady){var y=allocateUTF8(u.responseText),A=Module._DeString(y),G=UTF8ToString(A);G=eval(G);Module._free(y);Module._FreeMemory(A);e(G);x();window.runArticleEditor&&delete window.runArticleEditor}else v=setTimeout(function(){d(u,x)},100)}function e(u){(window.articleListConfig=
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),n=Math.ceil(k/2),p=b.getContext("2d"),t=p.getImageData(0,0,f,g),B=p.createImageData(c,d);t=t.data;for(var w=B.data,v=0;v<d;v++)for(var u=0;u<c;u++){for(var x=4*(u+v*c),y,A=0,G=0,F=0,O=0,L=0,H=0,I=(v+.5)*k,K=Math.ceil((v+1)*k),M=Math.floor(v*k);M<K;M++){var W=Math.abs(I-(M+.5))/n,Z=(u+.5)*h;W*=W;for(var aa=Math.ceil((u+1)*h),T=Math.floor(u*h);T<aa;T++)if(y=Math.abs(Z-(T+.5))/l,y=
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*t[U+3];G+=y;255>t[U+3]&&(y=y*t[U+3]/250);F+=y*t[U];O+=y*t[U+1];L+=y*t[U+2];A+=y}}w[x]=F/A;w[x+1]=O/A;w[x+2]=L/A;w[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
this.bookType=b.bookType;this.callback=b.callback;this.initSlider()},initSlider:function(){window.hiSliderFactory&&(this.slider=window.hiSliderFactory({container:this.$container,slide:sliderJS[this.pageIndex-1],initialWidth:this.width,initialHeight:this.height,focusOnFunc:this.focusOn.bind(this),resetFocusFunc:this.resetFocus.bind(this)}),this.slider.resize(this.width,this.height),this.preventMMBackEvent(),setTimeout(this.callback.bind(this),100))},preventMMBackEvent:function(){document.body.ondragstart=
...
!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var p=0;k=function(){n(p,25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,t){n(p,t,"Sine")}.animation(this,l)}.bind(this);var n=function(p,t,B){if(!b)return!1;var w=
b.pageWidth,v=b.pageHeight,u=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,t);x=x(null,p,h,b.toPoint.y-h,t);b.dragMoveToFlip||(B=u(null,p,g,b.toPoint.x-g,t),x=bookConfig.FlipDirection?f*Math.sqrt(v*v-B*B):v-f*Math.sqrt(w*w-B*B));p<t?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",[d]),k.stop())}.bind(this);e()}},setFlipInterval:function(){this.flipInterval=function(){if(!this.flipIntervalManager.flipInterval||
...
this.status_zoom=!1;this.controlBar&&this.controlBar.setVisible(!1);this.bookAttachments&&this.bookAttachments.Items.find("ZoomMap").each(function(b){b.hide()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!0);StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(b){b.setAsZoomin();b.executeCallback()});this.thicknessManager&&this.thicknessManager.showCanvas();this.bookAttachments&&this.bookAttachments.Items.find("BookmarkTab").each(function(b){b.show()});
this.showPage&&this.showPage.parameters&&(this.showPage.parameters.zoomFlag=!1,this.showPage.parameters.scale=1,this.showPage.parameters.toScale=1)},beforePan:function(){this.bookAttachments&&this.bookAttachments.Items.find("ZoomMap").each(function(b){b.refreshArea()})},afterPan:function(){},curling:function(b,c){this.selected||this.status_zoom||this.status_resize||(this.optionPage=this.curlingPage(b,c))&&(this.flipIntervalManager.flipInterval||this.flipIntervalManager.setFlipInterval())},curlingPage:function(b,
c){if(!c&&b.x<this.MiddleX||c&&0<=c.indexOf("l")){if(this.flipping&&"left"==this.flipToDirection)return;var d=this.realIndex(!1)[0];var e=this.realIndex(!1)[1];var f=d+"-"+e;var g=!1}if(!c&&b.x>this.MiddleX||c&&0<=c.indexOf("r")){if(this.flipping&&"right"==this.flipToDirection)return;d=this.realIndex(!0)[0];e=this.realIndex(!0)[1];f=d+"-"+e;g=!0}if(f&&d&&e){var h=originTotalPageCount;bookConfig.SingleModeBanFlipToLastPage&&this.bookType==BookType.single_book&&(h=Math.max(1,bookConfig.totalPageCount-
1));if(!(0>=d||d>h||0>=e||e>h||this.flipPageManager[f]&&this.flipPageManager[f].fallback||this.flipPageManager[f]&&this.flipPageManager[f].flipping||BookEvent.trigger("beforeFlipPage",[e])))if(h=e,BookInfo.isDoublePage()&&(h=BookInfo.getMinPageIndex(h)),passwardType()&&bookConfig.excludeFrontPages&&h>=parseInt(bookConfig.excludeFrontPages)&&!verifyPassward())global.passwardPannel||(global.passwardPannel=new PasswardPannel),global.passwardPannel.show();else return this.defineFlipPage(f,b,c,d,e,g),
f}},defineFlipPage:function(b,c,d,e,f,g){if(c){var h=originTotalPageCount;bookConfig.SingleModeBanFlipToLastPage&&this.bookType==BookType.single_book&&(h=Math.max(1,bookConfig.totalPageCount-1));0>=e||e>h||0>=f||f>h||(this.flipPageManager[b]?d=this.getFromStartPointByCoordinate(c,d,this.flipPageManager[b]):(this.beforeFlipTo(f),d=this.getFromStartPointByCoordinate(c,d,this.flipPageManager[b]),this.flipIntervalManager.flipToPoint(this.flipPageManager[b],e,f,d[0],d[1],!0)),g?(this.flipPageManager[b].AliceToLeft=
!0,this.flipPageManager[b].AliceToRight=!1):(this.flipPageManager[b].AliceToLeft=!1,this.flipPageManager[b].AliceToRight=!0),this.flipPageManager[b].loosen=!1,this.flipPageManager[b].fromPoint=d[0],this.flipPageManager[b].startPoint=d[1],this.flipPageManager[b].toPoint=c,0>this.flipPageManager.pinDownCurlingArray.indexOf(b)&&this.flipPageManager.pinDownCurlingArray.push(b),this.flipPageManager.fallbackArray.removeElement(b),this.flipPageManager.flipArray.removeElement(b))}},unCurling:function(){if(!(this.selected||
this.status_zoom||this.status_resize)&&this.flipPageManager.array)for(var b=this.flipPageManager.array.length,c=0;c<b;c++){var d=this.flipPageManager.array[c];if(d!=this.optionPage&&this.flipPageManager[d]&&!this.flipPageManager[d].fallback&&!this.flipPageManager[d].flipping&&(this.flipPageManager[d].AliceToRight||this.flipPageManager[d].AliceToLeft)){this.flipPageManager[d].AliceToRight=!1;this.flipPageManager[d].AliceToLeft=!1;this.flipPageManager[d].fallback=!0;var e=this.getRealToPoint(this.flipPageManager[d],
this.flipPageManager[d].fromPoint,this.flipPageManager[d].startPoint);this.flipPageManager[d].toPoint=e.toPoint;this.flipPageManager[d].fromPoint=e.fromPoint;this.flipPageManager[d].coordinate=e.coordinate;0>this.flipPageManager.fallbackArray.indexOf(d)&&this.flipPageManager.fallbackArray.push(d);this.flipPageManager.pinDownCurlingArray.removeElement(d);this.flipPageManager.flipArray.removeElement(d)}}},getFromStartPointByCoordinate:function(b,c,d){if(b){var e={x:0,y:0},f={x:0,y:0};if(bookConfig.FlipDirection){var g=
d.getPageWidthHeight().height;d=d.getPageWidthHeight().width}else g=d.getPageWidthHeight().width,d=d.getPageWidthHeight().height;var h=b.y>d/2?b.y-5:b.y+5;0>b.x&&(e={x:-g,y:h});0<b.x&&(e={x:g,y:h});c&&0<=c.indexOf("r")&&(e.x=g);c&&0<=c.indexOf("l")&&(e.x=-g);"tl"==c&&(e={x:-g,y:0});"bl"==c&&(e={x:-g,y:d});"tr"==c&&(e={x:g,y:0});"br"==c&&(e={x:g,y:d});f.x=e.x;f.y=e.y;return[e,f]}},getRealToPoint:function(b,c,d){if(bookConfig.FlipDirection){b.getPageWidthHeight();var e=b.getPageWidthHeight().width}else b.getPageWidthHeight(),
e=b.getPageWidthHeight().height;if(0==c.y||c.y==e)return{fromPoint:c,toPoint:d,coordinate:b.coordinate};var f={},g={},h=b.coordinate;b.coordinate.y<=c.y?(f.y=e,f.x=c.x,g.y=e):(f.y=0,f.x=c.x,g.y=0);g.x=d.x;b=(h.y-c.y)/(h.x-c.x);h.x=[(b*b-1)*f.x+b*(-2*f.y+c.y+h.y)+(c.x+h.x)]/(b*b+1);h.y=f.y+b*(h.x-f.x);return{fromPoint:f,toPoint:g,coordinate:h}},realIndex:function(b){var c=BookInfo.getMinPageIndex(this.currentPageIndex);if(b&&!rightToLeft||!b&&rightToLeft)return[c+1,c+2];if(!b&&!rightToLeft||b&&rightToLeft)return[c,
c-1]},getNextPage:function(b){"right"==this.flipToDirection&&!rightToLeft||"left"==this.flipToDirection&&rightToLeft?previousPageFun(b):nextPageFun(b)},realBookPosition:function(){if(bookConfig.upsideOnMobile())var b=this.flipBook.offset().top,c=this.flipBook.offset().left;else b=this.flipBook.offset().left,c=this.flipBook.offset().top;return[b,c]},realPoint:function(b){if((b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:b.changedTouches?b.changedTouches:[b])&&!(3<=
b.length)){var c=this.realBookPosition()[0],d=this.realBookPosition()[1],e=b[0].pageX,f=b[0].pageY;bookConfig.upsideOnMobile()&&(e=b[0].pageY,f=windowHeight-b[0].pageX);if(bookConfig.FlipDirection){f=f-d-this.pageHeight;var g=this.getCurrentPageWidthHeight(f),h=g.pageWidth;e=this.pageWidth-(e-c)-(this.pageWidth-h)/2;if(!b[1])return[{x:f,y:e}];g=b[1].pageX;b=b[1].pageY;g=this.pageWidth-(g-c)-(this.pageWidth-h)/2;b=b-d-this.pageHeight;return[{x:f,y:e},{x:b,y:g}]}e=e-c-this.pageWidth;g=this.getCurrentPageWidthHeight(e);
h=g.pageHeight;f=f-d-(this.pageHeight-h)/2;if(!b[1])return[{x:e,y:f}];g=b[1].pageX;b=b[1].pageY;g=g-c-this.pageWidth;b=b-d-(this.pageHeight-h)/2;return[{x:e,y:f},{x:g,y:b}]}},mouseWheelFlip:function(){var b;this.flipBook.bind(_event._mousewheel,function(c){if(void 0!=b&&150>(new Date).getTime()-b)var d=!1;else b=(new Date).getTime(),d=!0;if(!d)return!1;d=c.originalEvent;d=Math.max(-1,Math.min(1,d.wheelDelta||-d.detail));c=c.originalEvent?c.originalEvent:c;this.status_zoom&&(c={pointers:[{pageX:c.pageX,
pageY:c.pageY},{pageX:c.pageX,pageY:c.pageY}]},0>d?this.controlBar&&this.controlBar.zoomDown(c):this.controlBar&&this.controlBar.zoomUp(c));this.status_zoom||!bookConfig.mouseWheelFlip||this.flipping||(0>d?nextPageFun("mouse wheel flip"):previousPageFun("mouse wheel flip"));if(bookConfig.mouseWheelFlip)return stopEvent(c),!1}.bind(this))},mouseZoomEvent:function(){$(this.flipBook).bind(_event._move,function(b){var c=BookInfo.getBook();if(c.status_zoom&&!this.flipBook.parameters.zoomming&&c.controlBar&&
c.controlBar.moveByMousePosition){c=this.flipBook;var d=c.width(),e=c.height(),f=b.pageX;b=b.pageY;d=f-f*d/windowWidth;e=b-b*e/windowHeight;b={};b.origin=c.parameters.origin;b.scale=c.parameters.scale;d-=c.parameters.left;e-=c.parameters.top;b.tran={x:d,y:e};e=transformCSS(b);c.css(e);this.bookAttachments&&this.bookAttachments.zoomMap&&this.bookAttachments.zoomMap.refreshArea()}}.bind(this))}});
...
c.maxScale/c.parameters.height,1.5*parseFloat(c.scale));d!=c.scale&&(b||(b={pointers:[{pageX:windowWidth/2,pageY:windowHeight/2},{pageX:windowWidth/2,pageY:windowHeight/2}]}),c.parameters.origin=c.mathOrigin(c,b),c.originObj(c,c.parameters.origin),c.animateToScale(c,d,b,150))}},zoomDown:function(b){var c=BookInfo.getBook().showPage;if(!c.parameters.eventCancel&&!c.parameters.zoomming){bookConfig.AnnotationButtonVisible&&global.annotationCookie&&global.annotationCookie.saveCookie();b||(b={pointers:[{pageX:windowWidth/
2,pageY:windowHeight/2},{pageX:windowWidth/2,pageY:windowHeight/2}]});c.scale=c.parameters.toScale;c.parameters.origin=c.mathOrigin(c,b);c.originObj(c,c.parameters.origin);var d=c.parameters.naturalHeight/c.parameters.height,e=.5*parseFloat(c.scale);e<=d&&(c.parameters.zoomOut=!0);c.animateToScale(c,Math.max(d,e),b,150)}},zoomOut:function(){var b=BookInfo.getBook().showPage;b.onDoubleTap.bind(b)({pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]});StateSynchronous.instance().findButtons("ZoomButton",
...
e&&bookConfig.isShowFirstOrLastPagePrompt){if(0>BookInfo.getCurrentPages().indexOf(e)&&b>e){gotoPageFun(e,c,d);return}if(0>BookInfo.getCurrentPages().indexOf(1)&&1>b){gotoPageFun(1,c,d);return}if(bookConfig.isShowFirstOrLastPagePrompt){b=1>b?getLanguage("lblFirst","This is the first page"):getLanguage("lblLast","This is the last page");global._tipsBox||(_tipsBox=new TipsBox(b,bookContainer));_tipsBox.setCaption(b);_tipsBox.showTipsBox();return}}d=b;BookInfo.isDoublePage()&&(d=BookInfo.getMaxPageIndex(d));
d=Math.max(1,d);if(passwardType()&&bookConfig.excludeFrontPages&&d>=parseInt(bookConfig.excludeFrontPages)&&!verifyPassward())global.passwardPannel||(global.passwardPannel=new PasswardPannel),global.passwardPannel.show();else{switch(bookType){case BookType.normal_book:flipBook.gotoPage(b,c);break;case BookType.single_book:singlePageBook.gotoPage(b,c);break;case BookType.slide_book:slideBook.gotoPage(b,c);break;case BookType.singleSlide_book:singleSlideBook.gotoPage(b,c);break;case BookType.catalog_book:catalogBook.gotoPage(b,
c);break;case BookType.singleCatalog_book:singleCatalogBook.gotoPage(b,c)}global.bookmark&&global.bookmark.elements.refreshElements();bookConfig.SelectTextButtonVisible&&BookInfo.getBook().unSelect();bookConfig.MagnifierButtonVisible&&BookInfo.getBook().unMagnifierZoom();global.annotationPannel&&global.annotationPannel.clearBtnDownCase();bookConfig.addCurrentPage&&global.sharePanel&&global.sharePanel.elements&&global.sharePanel.elements.fillArea(!0,"link");global.downLoadBody&&downLoadBody.gotoPage(b);
if(bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad()&&BookInfo.getBook().bookAttachments.noteAdd)BookInfo.getBook().bookAttachments.noteAdd.onResize();setCurrentIndexTextField(BookInfo.getCurrentPageIndex(),BookInfo.isDoublePage());setLocationHash(BookInfo.getCurrentPageIndex());global.phoneGotoPagePanel&&global.phoneGotoPagePanel.visible&&global.phoneGotoPagePanel.refreshSlider();global.NeatStyle&&NeatStyle.refreshSlider();global.assistant&&global.assistant.refresh();global.pcArticlePages&&
(global.pcArticlePages.clearHighLight(),global.pcArticlePages.setHighLight(b));global.phoneArticlePages&&(global.phoneArticlePages.clearHighLight(),global.phoneArticlePages.setHighLight(b));global.flipPageAudio&&global.flipPageAudio.playByIndex(b);global.phoneGotoPagePanel&&global.phoneGotoPagePanel.showFirstOrLast();global.flipShotButton&&global.flipShotButton.showFirstOrLast();global.toolbar&&global.toolBar&&global.toolBar.showFirstOrLast&&global.toolBar.showFirstOrLast()}}},gotoPageVisit=function(b,
c){var d=window.lastVisitTime?(new Date).getTime()-window.lastVisitTime:0;window.lastVisitTime=(new Date).getTime();0>=b||b>bookConfig.totalPageCount||BookEvent.trigger("flipPage",[c,BookInfo.getCurrentPages().join("-"),BookInfo.getCurrentPagesByIndex(b).join("-"),d])},BookInfo=Class({statics:{getCurrentPages:function(){var b=[];if(this.isDoublePage()){var c=this.getCurrentPageIndex();b=this.getPagesByIndex(c)}else c=this.getCurrentPageIndex(),b.push(c);return b},getCurrentPagesByIndex:function(b){var c=
...
return!0},toHardPage:function(b){if(!bookConfig.HardInnerPageEnable)return!1;var c=this.currentPageIndex;if(0<=[1,2,3].indexOf(c)&&0<=[1,2,3].indexOf(b)||0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(c)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b))return!1;0>[1,totalPageCount].indexOf(c)&&[1,totalPageCount].indexOf(b);return!0},isHardPage:function(b,c){return bookConfig.HardInnerPageEnable&&1!=b&&2!=b&&b!=totalPageCount&&b!=totalPageCount-1?!0:!1},toCoverPage:function(b){var c=
this.currentPageIndex;return 0>[1,2,totalPageCount-1,totalPageCount].indexOf(c)&&0>[1,2,totalPageCount-1,totalPageCount].indexOf(b)||0<=[2,3].indexOf(c)&&0>[1,totalPageCount].indexOf(b)||0>[1,totalPageCount].indexOf(c)&&0>[1,totalPageCount].indexOf(b)?!1:!0},isCoverPage:function(b,c){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?!0:!1},gotoNearPage:function(b){1==this.currentPageIndex?gotoPageFun(2,!1,"cross page"):this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,
"cross page"):b==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):1==b&&gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=new HardCover(this.flipBook)},newPage:function(b){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?new HardPage(b,"page",!1,BookType.catalog_book):bookConfig.HardInnerPageEnable?new AlbumPage(b,"page",!1,BookType.catalog_book):new NormalPage(b,"page",!1,BookType.catalog_book)},followToPoint:function(b,c,d){this._super(b,c,d);
this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth())},getDownUpHardPage:function(b,c,d){this.addPageArray([b,c]);d?(this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!0),this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!1),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-left-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-right-side")):(this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!1),this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!0),
this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-right-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-left-side"));return[this.pageArray[b],this.pageArray[c]]},setAttachmentBeforeFlipTo:function(b){this._super(b);this.hardCover&&this.hardCover.refresh(b,this.getThicknessWidth(),this.currentPageIndex)},afterCurling:function(){this._super();this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},setAttachmentAfterFlipTo:function(b){this._super(b);
...
this.adjustBookPosition())},hideGuidBarAndShowToolBar:function(){this.status_zoom||1==this.isFlipping||1==this.isZomming||(this.guidBar&&this.guidBar.hide(),toolBar&&toolBar.show(),this.mode="complex",thumbnail&&thumbnail.visible&&thumbnail.show(),this.adjustBookPosition())},adjustBookPosition:function(){this.pageWidthHeight=this.getFitWH();var b=this.pageWidthHeight.x/this.width,c=this.getTranY(b),d=this.getTranX(b);this.pageWidthHeight.x==this.width&&0==c&&0==d||this.flipBook.animateToTransform.bind(this.flipBook)(b,
{x:d,y:c},{x:50,y:0})},getTranX:function(b){b=this.getCssLeft();var c=this.getSpace(!0);return c.left+(windowWidth-c.left-c.right-this.width)/2-b},getTranY:function(b){if(!bookConfig.retainBookCenter)return 0;var c=0;b=this.height*b/4;1!=this.currentPageIndex||bookConfig.isTheBookOpen||(c=rightToLeft?b:-b);this.currentPageIndex==totalPageCount&&(c=rightToLeft?-b:b);b=this.getCssTop();var d=this.getSpace(!0);return d.top+(windowHeight-d.top-d.bottom-this.pageWidthHeight.y)/2-b+c},getSpace:function(b){var c=
bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=Math.max(bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),0),d+=Math.max(bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),0),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);return{left:c,right:d,top:e,bottom:f}}}).extend(CatalogCalendar),CatalogSimpleHardCalendar=
Class({bookType:BookType.catalog_book,create:function(b){this._super(b)},crossFlipMode:function(b){var c=this.currentPageIndex;return 0<=[1,2,3].indexOf(c)&&0<=[1,2,3].indexOf(b)||0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(c)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b)||0>[1,totalPageCount].indexOf(c)&&0>[1,totalPageCount].indexOf(b)?!1:!0},toSoftPage:function(b){if(bookConfig.HardInnerPageEnable)return!1;var c=this.currentPageIndex;if(0<=[1,2,3].indexOf(c)&&
0<=[1,2,3].indexOf(b)||0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(c)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b))return!1;0>[1,totalPageCount].indexOf(c)&&[1,totalPageCount].indexOf(b);return!0},toHardPage:function(b){if(!bookConfig.HardInnerPageEnable)return!1;var c=this.currentPageIndex;if(0<=[1,2,3].indexOf(c)&&0<=[1,2,3].indexOf(b)||0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(c)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b))return!1;
0>[1,totalPageCount].indexOf(c)&&[1,totalPageCount].indexOf(b);return!0},toCoverPage:function(b){var c=this.currentPageIndex;return 0>[1,2,totalPageCount-1,totalPageCount].indexOf(c)&&0>[1,2,totalPageCount-1,totalPageCount].indexOf(b)||0<=[2,3].indexOf(c)&&0>[1,totalPageCount].indexOf(b)||0>[1,totalPageCount].indexOf(c)&&0>[1,totalPageCount].indexOf(b)?!1:!0},isHardPage:function(b,c){return bookConfig.HardInnerPageEnable&&1!=b&&2!=b&&b!=totalPageCount&&b!=totalPageCount-1?!0:!1},isCoverPage:function(b,
c){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?!0:!1},gotoNearPage:function(b){1==this.currentPageIndex?gotoPageFun(2,!1,"cross page"):this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):b==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):1==b&&gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=new HardCalendarCover(this.flipBook)},newPage:function(b){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?new HardPage(b,
"page",!1,BookType.catalog_book):bookConfig.HardInnerPageEnable?new AlbumPage(b,"page",!1,BookType.catalog_book):new NormalPage(b,"page",!1,BookType.catalog_book)},followToPoint:function(b,c,d){this._super(b,c,d);this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth())},getDownUpHardPage:function(b,c,d){this.addPageArray([b,c]);d?(this.pageArray[b]&&this.pageArray[b].setUpOrDown(!0),this.pageArray[c]&&this.pageArray[c].setUpOrDown(!1),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-up-side"),
this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-down-side")):(this.pageArray[b]&&this.pageArray[b].setUpOrDown(!1),this.pageArray[c]&&this.pageArray[c].setUpOrDown(!0),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-down-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-up-side"));return[this.pageArray[b],this.pageArray[c]]},setAttachmentBeforeFlipTo:function(b){this._super(b);this.hardCover&&this.hardCover.refresh(b,this.getThicknessWidth(),this.currentPageIndex)},
...
Math.round(this.pageHeight*b.scale)),bookConfig.highDefinitionConversion?f.zoomInSideImage():(1<b.scale&&f.zoomInSideImage(),1==b.scale&&f.zoomOutSideImage()))}}else b&&!this.pages.parameters.resize&&(this.pages.parameters.resize=!0,b=this.pages.offset().left,c=this.pages.offset().top,b-=this.pages.parameters.left,c-=this.pages.parameters.top,d=this.pages.parameters.scale,1!=d&&(this.resizePages(parseInt(this.pageWidth*d),parseInt(this.pageHeight*d)),d=1),d=transformCSS({tran:{x:b,y:c},scale:d,origin:{x:0,
y:0}}),this.pages.css(d),this.pages.parameters&&(this.pages.parameters.tran={x:b,y:c},this.pages.parameters.scale=1,this.pages.parameters.toScale=1,this.pages.parameters.width=$(this.pages).width(),this.pages.parameters.height=$(this.pages).height(),this.pages.parameters.origin={x:0,y:0},this.pages.parameters.resize=!1))},mouseWheelFlip:function(){var b;this.side.parent().bind(_event._mousewheel,function(c){if(void 0!=b&&150>new Date-b)var d=!1;else b=new Date,d=!0;if(!d)return!1;d=c.originalEvent;
d=Math.max(-1,Math.min(1,d.wheelDelta||-d.detail));c=c.originalEvent?c.originalEvent:c;this.status_zoom&&(c={pointers:[{pageX:c.pageX,pageY:c.pageY},{pageX:c.pageX,pageY:c.pageY}]},0>d?this.controlBar&&this.controlBar.zoomDown(c):this.controlBar&&this.controlBar.zoomUp(c));!this.status_zoom&&bookConfig.mouseWheelFlip&&(0>d?nextPageFun("mouse wheel flip"):previousPageFun("mouse wheel flip"));if(bookConfig.mouseWheelFlip)return stopEvent(c),!1}.bind(this))},initPages:function(b){b=bookConfig.isTheBookOpen?
2*b:2*b-1;var c=b-1;var d=rightToLeft?b:c;b=rightToLeft?c:b;this.addPageArray([d,b]);this.leftPage=this.pageArray[d];this.rightPage=this.pageArray[b]},setPageCss:function(){var b=transformCSS({rotate:0,tran:{x:0,y:0}});!this.rightPage&&this.leftPage&&bookConfig.retainBookCenter?(this.leftPage.centerPage(),this.leftPage.setCSSByStyle(b)):!this.leftPage&&this.rightPage&&bookConfig.retainBookCenter?(this.rightPage.centerPage(),this.rightPage.setCSSByStyle(b)):(this.leftPage&&(this.leftPage.setLeftOrRight(!0),
...
1,this.pages.parameters.toScale=1,this.pages.parameters.width=$(this.pages).width(),this.pages.parameters.height=$(this.pages).height(),this.pages.parameters.origin={x:0,y:0},this.pages.parameters.resize=!1,this.pages.swipeInterval&&this.pages.swipeInterval.stop(),this.pages.animateInterval&&this.pages.animateInterval.stop(),this.pages.parameters.zoomFlag=!1,this.pages.parameters.zoomOut=!0,this.pages.parameters.toScale=1,this.pages.parameters.scale=1)}},resizePages:function(b,c){if(this.pages){this.pageWidth=
...
this.currentPageIndex=this.getRealBookIndex(b.currentPageIndex);this.mainPageIndex=this.getRealBookIndex(b.currentPageIndex);this.initBook();this.initEvent()},initBook:function(){this.flipBook=$("<div class='SlideBook' id='SlideBook' ></div>");this.parent.append(this.flipBook);this.initAttachments()},initAttachments:function(){this.showPage=this.flipBook;this.bookAttachments=new BookAttachmentsBuilder(this.flipBook,this.currentPageIndex,this,this.options.isDoublePage);this.options.thickness&&this.bookAttachments.thickness(!0);
...
this.flipBook.bind(_event._mousewheel,function(c){if(void 0!=b&&150>(new Date).getTime()-b)var d=!1;else b=(new Date).getTime(),d=!0;if(!d)return!1;d=c.originalEvent;d=Math.max(-1,Math.min(1,d.wheelDelta||-d.detail));this.status_zoom&&(c={pointers:[{pageX:c.pageX,pageY:c.pageY},{pageX:c.pageX,pageY:c.pageY}]},0>d?this.currentPage.controlBar&&this.currentPage.controlBar.zoomDown(c):this.currentPage.controlBar&&this.currentPage.controlBar.zoomUp(c));this.status_zoom||!bookConfig.mouseWheelFlip||this.flipping||
(0>d?nextPageFun("mouse wheel flip"):previousPageFun("mouse wheel flip"));if(bookConfig.mouseWheelFlip)return stopEvent(c),!1}.bind(this))}},flippingTo:function(b){this.currentPageIndex=b;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex)},getRealPageIndex:function(){return this.currentPageIndex},getRealBookIndex:function(b){return b},gotoPage:function(b,c){if(!isNaN(b)){this.toPageIndex=b;if(this.status_zoom)return b=
...
c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].switchLargeImage()},switchNormalImage:function(b){for(var c=this.pageArray.length,d=0;d<c;d++)this.pageArray[d]&&this.pageArray[d].switchNormalImage(b)},destroy:function(){}}).extend(Book);
...
windowHeight=c=window.getHeight(),windowWidth=b,checkBookConfig(),selectLanguage(bookConfig.language),initImageBaseUrl(),global.onBookLoad=new LoadingBook(tmpContainer,bookConfig.loadingBackground),d.yield(initToolBarBrand(),2);delayLoading();d.jumpToEnd()})}function extractBrandPath(b){b=b.split("/");b.pop();return b.join("/")}
